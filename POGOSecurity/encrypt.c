...
unsigned char* encryptChain(unsigned char *input, unsigned char*output)
{
    _DWORD temp[0x32C / 4];
...
unsigned char* encryptUnknown6(const unsigned char *input, size_t input_size, const unsigned char* iv, size_t iv_size, unsigned char* output, size_t * output_size) {
    ...
    for (size_t offset = 32; offset < totalsize; offset += 256)
    {
        ...
        encryptChain(output + offset, arr3); // !! encryption here
